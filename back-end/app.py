...
def add_database_rules():
    with app.app_context():  
        ...
        dg2 = DrugModel(name='热清灵颗粒',desc='去火', manufacturedate='2022-10-2',duedate='2024-10-2', owner=1, img='app/static/images/2.jpg'
                        ,clockFlags='0000',clockTime='0000080012001800',weekFrequency='0000000',telephone='18860184392')
        dg3 = DrugModel(name='福尔马林',desc='防腐', manufacturedate='2022-10-3',duedate='2024-10-3', owner=2, img='app/static/images/3.jpg'
        ...
        dg5 = DrugModel(name='枸橼酸钠',desc='治疗肾结石', manufacturedate='2022-10-4',duedate='2024-10-4', owner=1, img='app/static/images/4.jpg'
                        ,clockFlags='0000',clockTime='0000080012001800',weekFrequency='0000000',telephone='18860184392')
        dg6 = DrugModel(name='双氯芬酸钠',desc='解热镇痛', manufacturedate='2022-10-4',duedate='2024-10-4', owner=1, img='app/static/images/4.jpg'
                        ,clockFlags='0000',clockTime='0000080012001800',weekFrequency='0000000',telephone='18860184392')
        dg7 = DrugModel(name='盐酸坦索罗缓释胶囊',desc='治疗前列腺炎', manufacturedate='2022-10-4',duedate='2024-10-4', owner=2, img='app/static/images/4.jpg'
                        ,clockFlags='0000',clockTime='0000080012001800',weekFrequency='0000000', telephone = '19860234392')
